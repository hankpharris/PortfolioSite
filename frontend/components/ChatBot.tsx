...
export function ChatBot() {
  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={setIsOpen}>
      ...
      <Dialog.Portal>
        <Dialog.Content 
          className="fixed top-[88px] right-4 bottom-4 w-full max-w-md bg-white/30 backdrop-blur-md shadow-xl z-[101] rounded-xl transform transition-transform duration-500 ease-in-out translate-x-full data-[state=open]:translate-x-0"
        >
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              ...
              <div className="flex justify-start">
                <div className="max-w-[80%] rounded-lg p-3 bg-white/50 backdrop-blur-sm text-gray-800 whitespace-pre-line">
            ...
            <form onSubmit={handleSubmit} className="p-4 border-t border-gray-200/50">
              <div className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="bg-blue-600/80 backdrop-blur-sm text-white p-2 rounded-lg hover:bg-blue-700/80 transition-colors"
                >
                  <Send size={20} />
                </button>
              </div>
